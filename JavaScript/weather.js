...
updateWeatherApp = (city) => {
    ...
    <div class="card-mid row">
            <div class="col-8 text-center temp">
              <span>${functionCelcius(city.main.temp)}&deg;C</span>
            </div>
            <div class="col-4 condition-temp">
              <p class="condition">${city.weather[0].description}</p>
              <p class="high">${functionCelcius(city.main.temp_max)}&deg;C</p>
              <p class="low">${functionCelcius(city.main.temp_min)}&deg;C</p>
            </div>
          </div>
          ...
          <div class="card-bottom px-5 py-4 row">
            <div class="col text-center">
              <p>${functionCelcius(city.main.feels_like)}&deg;C</p>
